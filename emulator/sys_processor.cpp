...
#define CRYSTAL_CLOCK 	(2000000L)													// Clock cycles per second (2.0 Mhz)
#define FRAME_RATE      (60)

#define CYCLE_RATE 		(CRYSTAL_CLOCK/8)											// Cycles per second (8 clocks per cycle)
#define CYCLES_PER_FRAME (CYCLE_RATE/FRAME_RATE)
...
#define INPORT1()   HWIReadKeyboard()
#define OUTPORT1(n) HWIWriteVideoPort(n)
...
BYTE8 CPUExecuteInstruction(void) {
    ...
    __1802Interrupt();                                                              // Frame over, fire interrupt maybe.
