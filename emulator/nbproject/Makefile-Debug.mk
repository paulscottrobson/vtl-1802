...
${OBJECTDIR}/framework/debugger.o: framework/debugger.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -DINCLUDE_DEBUGGING_SUPPORT -I/usr/include/SDL2 -I. -I./framework -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/framework/debugger.o framework/debugger.cpp

${OBJECTDIR}/framework/gfx.o: framework/gfx.cpp
	${MKDIR} -p ${OBJECTDIR}/framework
	${RM} "$@.d"
	$(COMPILE.cc) -g -DINCLUDE_DEBUGGING_SUPPORT -I/usr/include/SDL2 -I. -I./framework -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/framework/gfx.o framework/gfx.cpp

${OBJECTDIR}/framework/main.o: framework/main.cpp
	${MKDIR} -p ${OBJECTDIR}/framework
	${RM} "$@.d"
	$(COMPILE.cc) -g -DINCLUDE_DEBUGGING_SUPPORT -I/usr/include/SDL2 -I. -I./framework -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/framework/main.o framework/main.cpp
...
${OBJECTDIR}/sys_debug_1802.o: sys_debug_1802.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DINCLUDE_DEBUGGING_SUPPORT -I/usr/include/SDL2 -I. -I./framework -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sys_debug_1802.o sys_debug_1802.cpp

${OBJECTDIR}/sys_processor.o: sys_processor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DINCLUDE_DEBUGGING_SUPPORT -I/usr/include/SDL2 -I. -I./framework -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sys_processor.o sys_processor.cpp
